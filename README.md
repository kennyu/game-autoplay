...
**Full API docs**: See [`docs/SSE_API.md`](docs/SSE_API.md)
...
**Detailed examples**: See [`docs/SSE_API.md`](docs/SSE_API.md)
...
See [`docs/DEPLOYMENT.md`](docs/DEPLOYMENT.md) for Fly.io deployment guide.
...
Contributions welcome! See [`docs/`](docs/) for detailed documentation.
